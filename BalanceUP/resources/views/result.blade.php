...
// end for 34 pattern
       ...
       if (mainfood < 3 & sideDish < 3 & milk < 3 & t_sport != null & f_sport !=null) {
          statement = attach+"主食、副菜、牛乳・乳製品がたりていないようです。これらの食品がたりていないと、部活動やクラブチームでの練習や試合ですぐにバテたり、ケガをしやすくなったりします。朝・昼・夜の3食を残さずしっかり食べるようにしましょう！牛乳が飲めない人や苦手な人は、骨まで食べられる魚や緑のこい葉野菜（ほうれんそうなど）をできるだけ多く食べるようにしましょう。";
          commentTag.html(statement);
       }
