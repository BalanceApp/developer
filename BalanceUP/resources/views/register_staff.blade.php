					...
					<div class="row">
						<div class="col-sm-12">
							<div class="login-signin">
								...
								<form method="POST" class="form" action="{{ url('/store-staff') }}"
									id="kt_login_signin_form">
									@csrf
									<div style="display: block;margin-top: 60px; padding-left: 30px;">
										<div style="display: flex;" class="row">
											<label for="name" class="col-sm-3 py-4 px-8 h-auto text-right">名前<span
													style="color:red">*</span></label>
											<input onclick="clearerror();" type="text"
												class="col-sm-4 form-control h-auto form-control-solid py-4 px-8"
												id="name" name="name" placeholder="name">
										</div>
										<div style="display: flex;margin-top: 20px;" class="row">
											<label for="birthday"
												class="col-sm-3 py-4 px-8 h-auto text-right">生年月日</label>
											<input type="date"
												class="col-sm-4 form-control h-auto form-control-solid py-4 px-8"
											...
											<div class="form-check-inline">
												<label class="radio py-4 form-check-label" for="male">
													<input type="radio" checked name="sex" id="male"
														class="py-4 px-8 form-check-input">
													<span></span>男</label>
											</div>
											<div class="form-check-inline">
