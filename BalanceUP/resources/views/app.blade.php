...
<head>
   ...
   <link href="{{asset('others/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css')}}" rel="stylesheet"
      type="text/css" />
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
               ...
               <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                  ...
                  <div class="footer bg-white py-4 d-flex flex-lg-column"
                     style="position:fixed; bottom: 0px; width: 100vw;" id="kt_footer">
                     <!--begin::Container-->
                     <div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
                        ...
                        <div class="text-dark order-2 order-md-1">
                           ...
                           <a href="https://www.tsukuba.ac.jp/" target="_blank"
                              class="text-dark-75 text-hover-primary">筑波大学</a>
                        </div>
                        <!--end::Copyright-->
                        <!--end::Container-->
                     </div>
