									...
									<form method="POST" class="form" action="{{ url('/userinfocheck') }}" id="kt_login_signin_form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8" style="text-align:start;">
                                                <label for="name">名前<span style="color:red; padding-right:40px;">*</span></label>
                                                <input class="m-input" onclick="clearerror();" type="text" id="name" name="name">
                                            </div>
                                        </div>
                                        <div style="margin-top: 20px;" class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8" style="text-align:start;">
                                                ...
                                                <input class="m-input" type="date" id="birthday" name="birthday" style="padding: 7px 4px;">
                                            </div>
                                        </div>
                                        <div style="margin-top: 20px;" class="form-group row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-8" style="text-align:start;">
                                                ...
                                                <div class="form-check-inline">
                                                    ...
                                                    <input type="radio" checked name="sex" id="male" class="form-check-input">
                                                    <span></span>男</label>
                                                </div>
                                                <div class="form-check-inline">
                                        ...
                                        <div class="row" style="margin-top: 20px;">
                                            <div class="col-lg-2 col-md-2 col-sm-2"></div>
                                            <label class="col-lg-8 col-md-8 col-sm-8" style="text-align:start;">食物アレルギー</label>
                                        </div>
                                        <div style="margin-top: 20px;" class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4"></div>
                                            <div class="col-lg-6 col-md-6 col-sm-6" style="margin-top: 20px;text-align:start;">
                                                    <label for="refer-input">※その他の方のみ入力</label>
                                                    <input class="m-input" type="text" id="refer-input" name="refer-input" style="width: 50%;">
                                            </div>
                                        </div>
                                        <div style="margin-top: 40px;" class="row">
                                            <div class="col-lg-2 col-md-2 col-sm-2"></div>
                                            <label class="col-lg-2 col-md-2 col-sm-2" style="text-align:start;">ログイン情報</label>
                                            <input onclick="clearerror();" type="text" class="m-input col-lg-3 col-md-3 col-sm-3" id="userid" name="userid" placeholder="ID">
                                            <div class="col-lg-2 col-md-2 col-sm-2" style="margin-top: 20px;"></div>
                                            <input onclick="clearerror();" type="password" class="m-input col-lg-3 col-md-3 col-sm-3" id="password" name="password" placeholder="PW">
                                        </div>
